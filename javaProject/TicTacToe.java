...
public class TicTacToe{
  ...
  public static void main(String args[]){
    ...
    // TODO 1: Print welcome message(Hint: call printWelcomeMessage function )
    printWelcomeMessage();
  ...
  */
  public static String playGame(int gameOption) {
   ...
   // TODO 2: assign CROSS with plyaer1 and ZERO with player2


   // TODO 3: Initialize Board (assign board with new board)
  ...
  * **/
  // TODO 4:find the Error in this Function. //
  public static int getGameOption() {
    ...
    while(true){
      try {
        ...
        // TODO 5: Write if statement that can choose the game choice(1 or 2) and break if statement.
