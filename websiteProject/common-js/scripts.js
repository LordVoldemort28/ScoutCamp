...
function enableRadialProgress(){
	...
	$(".radial-progress").each(function(){
		...
		var bar = new ProgressBar.Circle(this, {
			...
			//CHANGE THE COLOR OF THE PROGRESS BAR HERE. A COMPUTER SEES COLOR THROUGH DIFFERENT NUMBERS CALLED 'HEX CODE'. 

			//CHANGE TO MAROON OR #762016
			from: { color: '#aaa', width: 1 },

			//CHANGE TO FOREST GREEN OR #33745b
